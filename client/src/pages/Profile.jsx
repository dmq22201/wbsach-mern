...
function Profile() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col gap-10 divide-y p-10 dark:divide-slate-700 dark:bg-slate-800 lg:grid lg:grid-cols-[17.625rem,1fr] lg:divide-x lg:divide-y-0">
